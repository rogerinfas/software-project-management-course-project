...
export const initialAppointments: AppointmentSlot[] = [
  {
    id: "apt-1",
    prospectId: "pro-1",
    tipo: "entrevista_familiar",
    fecha: "2026-05-20",
    horaInicio: "10:00",
    horaFin: "10:45",
    responsable: "Lic. Luisa Rojas",
    lugar: "Sala de Admisión",
    estado: "programada",
    notas: "Traer libreta de notas del año anterior.",
  },
  {
    id: "apt-2",
    prospectId: "pro-2",
    tipo: "evaluacion_academica",
    fecha: "2026-05-21",
    horaInicio: "09:00",
    horaFin: "10:00",
  ...
  },
  {
    ...
    horaInicio: "11:00",
    horaFin: "12:00",
    responsable: "Psic. Ana Torres",
    lugar: "Gabinete Psicopedagógico",
    estado: "realizada",
    notas: "Evaluación completada sin observaciones.",
  },
  {
    id: "apt-4",
    prospectId: "pro-4",
    ...
    lugar: "Sala de Admisión",
    estado: "cancelada",
    notas: "Familia solicitó reprogramación.",
  },
  {
    id: "apt-5",
    prospectId: "pro-1",
...
export const initialEvaluationResults: EvaluationResult[] = [
  {
    id: "evr-1",
    prospectId: "pro-3",
    aptitud: "apto",
    comentarios: "Excelente desempeño en evaluación académica y psicológica. Sin observaciones.",
    evaluador: "Lic. Luisa Rojas",
    fechaDictamen: "2026-04-10",
  },
  {
    id: "evr-2",
    prospectId: "pro-2",
    aptitud: "pendiente",
    comentarios: "Pendiente resultado de evaluación académica.",
    evaluador: "Diana Chávez",
    fechaDictamen: "2026-04-22",
  },
];
